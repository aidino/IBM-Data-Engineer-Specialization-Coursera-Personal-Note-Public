...
dag = DAG('update_dataflows', default_args=default_args, schedule_interval='30 12 * * 3') # At 12:30 on Wednesday
```
...
default_args={
    'email': ['airflowadmin@datacamp.com', 'airflowadmin@datacamp.com'],
